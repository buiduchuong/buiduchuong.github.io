...
(()=>{
  ...
  if(!window.__VN_FLAG_SHAPES&&!document.querySelector('script[data-vn-flag-shapes]')){
    const s=document.createElement('script');s.src='flag-shape-tools.js?v=4';s.dataset.vnFlagShapes='1';s.onerror=()=>console.warn('Không tải được thư viện shape cờ ngang');document.body.appendChild(s);
  }
})();
