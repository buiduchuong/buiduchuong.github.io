...
(()=>{
  ...
  const s=document.createElement('script');s.src='note-tools.js?v=3';s.dataset.vnNoteTool='1';s.onerror=()=>console.warn('Không tải được công cụ ghi chú');document.body.appendChild(s);
})();
