...
(()=>{
  ...
  if(!window.__VN_FLAG_SHAPES&&!document.querySelector('script[data-vn-flag-shapes]')){
    const s=document.createElement('script');s.src='flag-shape-tools.js?v=5';s.dataset.vnFlagShapes='1';s.onerror=()=>console.warn('Không tải được thư viện shape cờ ngang');document.body.appendChild(s);
  }
})();
...
(()=>{
  ...
  const s=document.createElement('script');s.src='note-tools.js?v=2';s.dataset.vnNoteTool='1';s.onerror=()=>console.warn('Không tải được công cụ ghi chú');document.body.appendChild(s);
})();
