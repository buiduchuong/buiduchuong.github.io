...
(()=>{
  ...
  const s=document.createElement('script');s.src='checkin-note-tools.js?v=3';s.dataset.vnCheckinNoteTool='1';s.onerror=()=>console.warn('Không tải được ghi chú 38 điểm check-in');document.body.appendChild(s);
})();
