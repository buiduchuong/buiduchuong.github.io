...
(()=>{
 ...
 const s=document.createElement('script');s.src='png-export-fix.js?v=14';s.dataset.vnPngExportFix='1';s.onerror=()=>console.warn('Không tải được bộ sửa xuất PNG 4K/8K');document.body.appendChild(s);
})();
