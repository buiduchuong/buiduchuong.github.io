...
// Cung đường dựng từ chương trình chuẩn 38 ngày - 37 đêm.
// Hà Nội là điểm khởi hành (★) nhưng không đánh số; số 1 bắt đầu tại Quảng Bình.
...
const ROUTE=[
 ...
 {name:'Quảng Bình · Nhật Lệ',lat:17.4580,lon:106.6359,num:2,bend:7,offset:{x:-7,y:-5},note:'Vũng Chùa - Đảo Yến, Nhật Lệ'},
 ...
 {name:'Huế',lat:16.456111,lon:107.576389,num:3,bend:6,offset:{x:-7,y:-5},note:'Chùa Thiên Mụ - Đại Nội'},
 {name:'Bà Nà Hills',lat:15.9950,lon:107.9880,hidden:true,bend:5},
 {name:'Đà Nẵng',lat:16.067780,lon:108.220830,num:4,bend:5,offset:{x:-8,y:-6},note:'Bán đảo Sơn Trà - Linh Ứng'},
 ...
 {name:'Pleiku',lat:13.971519,lon:108.014673,num:6,bend:-6,offset:{x:-7,y:-4}},
 {name:'Cửa khẩu Bờ Y',lat:14.7070,lon:107.7290,num:7,bend:-9,offset:{x:-5,y:-6},note:'Ngã ba Đông Dương'},
 {name:'Măng Đen',lat:14.600278,lon:108.290833,num:8,bend:9,offset:{x:7,y:-4},note:'Đức Mẹ Măng Đen - Thác Pa Sỹ - Hồ Đăk Ke'},
 {name:'Kon Tum',lat:14.3545,lon:108.0076,hidden:true,bend:-6},
 {name:'Pleiku',lat:13.971519,lon:108.014673,num:9,bend:-7,offset:{x:8,y:7},note:'Biển Hồ - Đường Thông Cổ'},
 {name:'Buôn Ma Thuột',lat:12.667470,lon:108.037750,num:10,bend:-5,offset:{x:-8,y:-5},note:'Biệt điện Bảo Đại - KoTam'},
 {name:'Thác Dray Sap',lat:12.5750,lon:107.8900,hidden:true,bend:-6},
 {name:'Buôn Đôn',lat:12.9180,lon:107.6690,num:11,bend:-8,offset:{x:-6,y:-5},note:'Cầu treo Sêrêpok - nhà cổ Lào'},
 {name:'Buôn Ma Thuột',lat:12.667470,lon:108.037750,hidden:true,bend:9},
 {name:'Tà Đùng',lat:11.8350,lon:107.9980,num:12,bend:-6,note:'KDL Tà Đùng Top View'},
 {name:'Đà Lạt',lat:11.9400,lon:108.4375,num:13,bend:6,note:'Trúc Lâm - Hồ Tuyền Lâm - Đường Hầm Đất Sét'},
 {name:'Bảo Lộc',lat:11.5470,lon:107.8070,hidden:true,bend:-4},
 {name:'TP.HCM',lat:10.823020,lon:106.629650,num:14,bend:9,offset:{x:-13,y:-10}},
 ...
 {name:'Cần Thơ',lat:10.037220,lon:105.788330,num:15,bend:5,note:'Nhà cổ Bình Thủy - Mỹ Khánh - Ninh Kiều'},
 ...
 {name:'Năm Căn',lat:8.7580,lon:104.9940,num:16,bend:-6,note:'Đất Mũi - Năm Căn'},
 ...
 {name:'Hà Tiên',lat:10.3833,lon:104.4875,num:17,bend:-7,note:'Thạch Động - Phù Dung - Núi Bình San - Lăng Mạc Cửu'},
 ...
 {name:'Châu Đốc',lat:10.7000,lon:105.116667,num:18,bend:5,note:'Miếu Bà Chúa Xứ'},
 ...
 {name:'Đồng Tháp · Sa Đéc',lat:10.310519,lon:105.739681,num:19,bend:6,note:'Tràm Chim - Làng hoa Sa Đéc'},
 {name:'TP.HCM',lat:10.823020,lon:106.629650,num:20,bend:10,offset:{x:13,y:-10},note:'Tham quan TP.HCM'},
 {name:'Tây Ninh',lat:11.364053,lon:106.180054,num:21,bend:-10,note:'Núi Bà Đen'},
 {name:'Địa đạo Củ Chi',lat:11.1420,lon:106.4610,hidden:true,bend:-7},
 {name:'TP.HCM',lat:10.823020,lon:106.629650,num:22,bend:10,offset:{x:0,y:13},note:'Quay lại TP.HCM trước chặng Vũng Tàu'},
 {name:'Vũng Tàu',lat:10.404167,lon:107.141667,num:23,bend:10},
 {name:'Phan Thiết',lat:10.9280,lon:108.1020,hidden:true,bend:8},
 {name:'Mũi Né',lat:10.981999,lon:108.251183,num:24,bend:8},
 {name:'Đồi Cát Bay · Bàu Sen',lat:11.0710,lon:108.3950,hidden:true,bend:5},
 {name:'Ninh Chữ',lat:11.5750,lon:109.0080,num:25,bend:6,note:'Ninh Thuận - Ninh Chữ'},
 {name:'Vườn nho Ninh Thuận',lat:11.7000,lon:109.0700,hidden:true,bend:4},
 {name:'Vịnh Vĩnh Hy',lat:11.7180,lon:109.1940,num:26,bend:5,note:'Vườn nho - Vịnh Vĩnh Hy'},
 {name:'Nha Trang',lat:12.2450,lon:109.191667,num:27,bend:5,note:'VinWonder - Suối Hoa Lan - Vịnh Nha Phu'},
 ...
 {name:'Phú Yên · Tuy Hòa',lat:13.086872,lon:109.308589,num:28,bend:6},
 ...
 {name:'Quy Nhơn',lat:13.769583,lon:109.231389,num:29,bend:-10,offset:{x:9,y:8}},
 ...
 {name:'Đảo Lý Sơn',lat:15.3800,lon:109.1200,num:30,mode:'sea',bend:8,offset:{x:5,y:-5}},
 ...
 {name:'Hội An',lat:15.877222,lon:108.329167,num:31,bend:-6,note:'Phố cổ Hội An'},
 ...
 {name:'Đà Nẵng',lat:16.067780,lon:108.220830,num:32,bend:-10,offset:{x:8,y:7}},
 {name:'KDL Núi Thần Tài',lat:15.9430,lon:107.9930,hidden:true,bend:-6},
 {name:'Biển Lăng Cô',lat:16.2460,lon:108.0790,num:33,bend:-7,offset:{x:7,y:5},note:'Lăng Cô - Cố đô Huế'},
 ...
 {name:'Đồng Hới · Bảo Ninh',lat:17.4580,lon:106.6359,num:34,bend:-12,offset:{x:8,y:6},note:'Biển Bảo Ninh - Tượng đài Mẹ Suốt'},
 ...
 {name:'Cửa Lò',lat:18.8100,lon:105.7160,num:35,bend:-7,note:'Cửa Lò - Làng Sen - Quê Bác'},
 {name:'Làng Sen · Kim Liên',lat:18.671430,lon:105.558720,hidden:true,bend:-6},
 {name:'Ninh Bình',lat:20.255694,lon:105.915611,num:36,bend:-7,note:'Hoa Lư - Tuyệt Tình Cốc - Tràng An - Hang Múa'},
 ...
 {name:'Hà Nội',lat:21.024167,lon:105.857778,num:37,finish:true,bend:-10,offset:{x:10,y:8},note:'Kết thúc hành trình 38 ngày - 37 đêm'}
];

// Đánh số hiển thị: Hà Nội đầu tuyến chỉ là ★, Quảng Bình bắt đầu số 1.
ROUTE.forEach(r=>{
 if(r.start)r.num=null;
 else if(Number.isFinite(r.num))r.num=r.num-1;
});
...
function addNumberMarker(g,r,active){
 if(r.start&&!r.num){
  g.appendChild(el('circle',{r:active?8.9:7.8,fill:'#fff','fill-opacity':'.98',stroke:'#f4b400','stroke-width':active?2.7:1.9,'vector-effect':'non-scaling-stroke'}));
  const star=el('text',{x:0,y:3.2,'text-anchor':'middle','font-family':'Arial,sans-serif','font-size':11,'font-weight':900,fill:'#f4b400','pointer-events':'none'});star.textContent='★';g.appendChild(star);return;
 }
 const finish=!!r.finish;g.appendChild(el('circle',{r:active?8.9:7.8,fill:'#fff','fill-opacity':'.98',stroke:finish?'#16803a':data.color,'stroke-width':active?2.7:1.9,'vector-effect':'non-scaling-stroke'}));if(data.showNumbers){const t=el('text',{x:0,y:2.25,'text-anchor':'middle','font-family':'Roboto,Arial,sans-serif','font-size':r.num>=10?5.6:6.5,'font-weight':900,fill:finish?'#16803a':data.color,'pointer-events':'none'});t.textContent=String(r.num);g.appendChild(t)}else g.appendChild(el('circle',{r:2.5,fill:finish?'#16803a':data.color,'pointer-events':'none'}));if(r.finish){const check=el('text',{x:8.4,y:-6.4,'text-anchor':'middle','font-family':'Arial,sans-serif','font-size':8.4,'font-weight':900,fill:'#16803a','pointer-events':'none'});check.textContent='✓';g.appendChild(check)}}
function render(){if(!layer)return;layer.innerHTML='';if(!data.show)return;ensureDefs();const segs=el('g',{id:'tourStandard38Segments'}),marks=el('g',{id:'tourStandard38Markers'});for(let i=0;i<data.points.length-1;i++){const s=data.points[i],e=data.points[i+1],c=controlPoint(s,e,data.bends[i]||0),sea=isSea(i),stroke=sea?data.seaColor:data.color;const p=el('path',{d:`M${s.x},${s.y} Q${c.x},${c.y} ${e.x},${e.y}`,fill:'none',stroke,'stroke-width':selected===i?Number(data.width)+1.05:data.width,'stroke-linecap':'round','stroke-linejoin':'round','vector-effect':'non-scaling-stroke',opacity:selected===i?'1':'.92',cursor:'pointer','data-tour-segment':i});if(sea)p.setAttribute('stroke-dasharray','7 5');if(shouldArrow(i))p.setAttribute('marker-end',sea?'url(#tourStandard38SeaArrow)':'url(#tourStandard38Arrow)');addTitle(p,`${ROUTE[i].name} → ${ROUTE[i+1].name}${sea?' · tàu/cano':''}`);p.addEventListener('click',ev=>{ev.stopPropagation();selected=i;syncSegment();render()});segs.appendChild(p)}ROUTE.forEach((r,i)=>{if(r.hidden||(!r.num&&!r.start))return;const p=data.points[i],o=off(i),g=el('g',{transform:`translate(${p.x+o.x} ${p.y+o.y})`,'data-tour-point':i,cursor:'grab'});const active=selectedPoint===i;addNumberMarker(g,r,active);addTitle(g,r.start&&!r.num?`★ ${r.name} · ${r.note||'Điểm khởi hành'}`:`${r.finish?'✓ ':''}${r.num}. ${r.name}${r.note?' · '+r.note:''}`);g.addEventListener('pointerdown',startPointDrag);g.addEventListener('click',ev=>{ev.stopPropagation();selectedPoint=i;syncPoint();render()});marks.appendChild(g)});layer.append(segs,marks)}
